      ...
      <div className='max-w-[1400px] mx-auto lg:px-3 w-full'>
        <div className='lg:w-full w-11/12 mx-auto h-full flex justify-between items-center'>
          ...
          <ul className='flex items-center xl:gap-12 gap-x-4 max-lg:hidden'>
            ...
            <button className='bg-primary rounded shadow h-16 px-12 outline-none text-white hover:bg-white hover:text-primary cursor-pointer text-base transition-bg hover:border hover:border-primary'>
              Get Exploration
            </button>
          </ul>
          {dropdown ? (
