...
const Navbar = () => {
  ...
  return (
    <nav className='w-full h-24 flex flex-col justify-center items-center lg:bg-transparent bg-whtie lg:relative fixed z-20'>
      <div className='container mx-atuo lg:px-6'>
        <div className='lg:w-full w-11/12 mx-auto h-full flex justify-between items-center'>
          ...
          <div className='flex max-lg:hidden gap-x-4'>
            <button className='bg-secondary rounded-[10px] p-2 border-none text-whtie cursor-pointer hover:bg-white hover:text-secondary'>
