  ...
  return (
    <html lang='en'>
      ...
      >
        <SmoothScrolling>
          {/* bg blur */}
          <div className='absolute left-0 hidden lg:block h-[400px] w-[400px] bg-white opacity-10 blur-3xl lg:-top-[100px]' />
          <Header />

          {/* bg blur */}

          <div className='absolute -right-0 hidden lg:block h-[400px] w-[400px] bg-white opacity-5 blur-3xl lg:top-[700px]' />
          {children}
          <Footer />
        </SmoothScrolling>
      </body>
